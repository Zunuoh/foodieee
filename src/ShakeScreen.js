...
const shakeList = [{"id":"0", "name":"Bournvitas Shake", "image":require('../assets/Shakes/bournvitashake.jpeg')}, {"id":"1", "name":"Choco Peanut", "image":require('../assets/Shakes/chocopeanut.jpeg')}, {"id":"2", "name":"Oreo Dessert", "image":require('../assets/Shakes/oreodessertpots.jpeg')},
{"id":"3", "name":"Oreo Shake", "image":require('../assets/Shakes/oreoshake.jpeg')}, {"id":"4", "name":"Salted Caramel Shake", "image":require('../assets/Shakes/saltedcaramelshake.jpeg')}, {"id":"5", "name":"Vanilla Banana Shake", "image":require('../assets/Shakes/vanillabanana.jpeg')}]
const ShakeScreen =()=>{
    ...
    return(
        ...
        <View style={{paddingTop:40}}>
            ...
            <View style={{marginTop:20}}>
                ...
                {shakes && shakes.map((shake)=>{
                return(
                <View style={{backgroundColor:"#EF5D5F", width:150, height:200, marginRight:10, marginTop:10, borderRadius:10}}>
                <View style={{justifyContent:"center", alignItems:"center", marginTop:20}}>
                <Image source={shake.image} style={{width:95, height:95, borderRadius:10}}/>
                </View>
                <View style={{paddingLeft:20, paddingTop:20}}>
                <Text style={{fontSize:20, color:"white"}}>{shake.name}</Text>
